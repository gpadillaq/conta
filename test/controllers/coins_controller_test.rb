...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { descripcion: @coin.descripcion, simbolo: @coin.simbolo } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { descripcion: @coin.descripcion, simbolo: @coin.simbolo } }
